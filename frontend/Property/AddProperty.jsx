    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} className="flex-1 bg-gray-50">
      ...
      >
        ...
        <View className="mt-28 mb-6">
          <Text className="text-2xl mt-16 font-bold text-gray-800">Add New Property</Text>
      ...
      <View className="absolute bottom-0 left-0 right-0 mb-10 bg-white border-t border-gray-200 px-0 py-4">
