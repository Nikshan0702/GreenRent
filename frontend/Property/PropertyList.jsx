...
//   const onCardPress = (item) => {
//     navigation.navigate('PropertyDetail', { property: item }); // 👉 unchanged
//   };
...
//         className="rounded-2xl overflow-hidden"
//         style={{
//           width: '48%',                // 2 columns with tidy gutters
//           backgroundColor: '#fff',
//           borderColor: '#e9eef5',
//           borderWidth: 1,
//           shadowColor: '#000',
...
//           shadowOffset: { width: 0, height: 3 },
//           elevation: 2,
//           marginBottom: 12            // uniform vertical rhythm
//         }}
//       >
//         {/* Image area */}
//         <View style={{ position: 'relative' }}>
...
//             <Image
//               source={{ uri: img }}
//               style={{ width: '100%', height: 132, backgroundColor: '#f3f4f6' }}
//               resizeMode="cover"
//             />
//           ) : (
//             <View style={{ width: '100%', height: 132 }} className="bg-gray-100 items-center justify-center">
//               <Ionicons name="image-outline" size={18} color="#9ca3af" />
//             </View>
//           )}
...
//       {/* ===================== Header (with Back) ===================== */}
//       <View
//         className={`${Platform.OS === 'android' ? 'pt-10' : 'pt-12'} pb-3 px-4 bg-white border-b border-gray-100`}
//         style={{ gap: 10 }} // consistent vertical gap within header
//       >
//         {/* Row: Back button · Title centered · Spacer right (keeps title centered) */}
  ...
  return (
    <View className="flex-1 mt-0 bg-[#f7f9fc]">
      ...
      <View
        ...
        style={{ gap: 10 }} // consistent vertical gap within header
      >
        {/* Row: Back button · Title centered · Actions right */}
        <View className="flex-row items-center justify-between">
          <TouchableOpacity
            onPress={() => navigation.goBack()}
            className="rounded-2xl"
          ...
          <View style={{ flexDirection: 'row' }}>
            <TouchableOpacity
              ...
              hitSlop={{ top: 6, bottom: 6, left: 6, right: 6 }}
            >
              <Ionicons name="git-compare-outline" size={18} color="#111827" />
            </TouchableOpacity>
            <TouchableOpacity
